...
@Component({
  selector: 'app-thailandmap-chart',
  templateUrl: './thailandmap-chart.component.html',
  styleUrl: './thailandmap-chart.component.css'
})
export class ThailandmapChartComponent {
